...
export default function TourCustomizationsPage() {
  ...
  const handleDelete = async (id: string, e: React.MouseEvent) => {
    ...
    if (!window.confirm('Are you sure you want to delete this customization request? This action cannot be undone.')) {
      return;
    }

    try {
      await deleteDoc(doc(db, 'tour_customizations', id));
            ...
            >
              <div className="flex items-start justify-between">
                ...
                <div className="ml-4 flex items-center space-x-2">
                  <button
                    onClick={(e) => handleDelete(customization.id, e)}
