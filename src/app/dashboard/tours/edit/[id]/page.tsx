...
export default function EditTourPage({ params }: { params: { id: string } }) {
      ...
      try {
        ...
        if (tourDoc.exists()) {
          ...
          setTourData({
            ...
            // Date validation fields
            minAdvanceBookingDays: data.minAdvanceBookingDays || 3,
            maxAdvanceBookingDays: data.maxAdvanceBookingDays || 180,
  ...
  const addBlackoutDate = () => {
    ...
    if (tourData.blackoutDates?.includes(blackoutDateInput)) {
      alert('This date is already in the blackout list');
      return;
    }
